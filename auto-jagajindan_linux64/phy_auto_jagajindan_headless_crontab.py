...
def dayoff():
    ...
    #    return True
        ...
        #print(url)
        #response = requests.get(parse.unquote(url))
...
if dayoff() == False: #True    
    ...
    driver = webdriver.Chrome('/home/gil000132/문서/vscode/auto-jagajindan/auto-jagajindan_linux64/chromedriver', options =  webdriver_options )
    ...
    print('학교 클릭')
    #성명 입력
    driver.find_element_by_xpath('//*[@id="user_name_input"]').send_keys('박한영')
    print('박한영 입력')
    #생년월일 입력
    driver.find_element_by_xpath('//*[@id="birthday_input"]').send_keys('040912')
    print('생년월일 입력')
    #확인 없어졌나봄
