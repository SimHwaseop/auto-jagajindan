...
tkinter.Label(window, text="Start page", font=('Helvetica', 18, "bold")).pack(side="top", fill="x", pady=5)
#tkinter.Button(window, text="Go to page one",command=lambda: master.switch_frame(PageOne)).pack()
#tkinter.Button(window, text="Go to page two",command=lambda: master.switch_frame(PageTwo)).pack()
